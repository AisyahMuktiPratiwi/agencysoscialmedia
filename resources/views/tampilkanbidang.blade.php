        ...
        <div class="card shadow-sm" style="background-color: rgba(255, 255, 255, 0.9);">
            <div class="card-body">
                <div class="card" style="color: rgb(163, 75, 102); box-shadow: 5px 6px 12px rgb(219, 217, 251); background-color: rgba(255, 255, 255, 0.9); padding: 20px;">
                    <h2 class="text-center mb-5 mt-5" style="font-family: 'Quintessential', cursive;"><b>Edit Data Bidang</b></h2>
                </div>
                <ol class="breadcrumb mb-4" style="background-color:  rgba(255, 255, 255, 0.9)">
                  <li class="breadcrumb-item"><a href="/bidang" style="color:rgb(163, 75, 102)">Data Bidang</a></li>
                  <li class="breadcrumb-item active" style="color:rgb(201, 167, 167)">Edit Data Bidang</li>
              </ol>
                <form action="/updatebidang/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label for="gambar" class="form-label">Gambar</label>
                        <br>
                        <img src="{{ asset('gambarbidang/'.$data->image) }}" alt="" style="width:40px;">
                        <input type="file" class="form-control" name="image">
                    </div>
                    <div class="mb-3">
                        <label for="gambar" class="form-label">Jenis Bidang</label>
                        <input type="text" value="{{$data->bidang}}" class="form-control" name="bidang">
                    </div>
