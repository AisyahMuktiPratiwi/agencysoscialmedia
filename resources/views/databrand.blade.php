            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <div class="card" style="background-color: rgb(255, 247, 247); box-shadow: rgb(219, 217, 251) 5px 6px 12px;">
                        <div class="card-body">
                            <h1 style="text-align:center; color: rgb(163, 75, 102); font-family: 'Quintessential', cursive;"><b>Kelola Data Konten</b></h1>
                        </div>
                    ...
                    <div class="col-sm-6 text-end">
                      <ol class="breadcrumb mb-4">
                          ...
                          <li class="breadcrumb-item active" style="color:rgb(201, 167, 167)">Data Konten Video</li>
                      </ol>
                  </div>
    ...
    <div class="container">
        <div class="card" style="box-shadow: rgb(219, 217, 251) 5px 6px 12px;">
            <div class="card-body">
                    ...
                    <table id="myTable" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/tampilkanbrand/{{ $row->id }}" style="color: rgb(255, 187, 0);"><i
                                            class="fas fa-edit"></i></a>
                                    <a href="/deletebrand/{{ $row->id }}"
                ...
                <a href="/tambahbrand"><i class="fas fa-plus-circle fa-3x"
