        ...
        <div class="card shadow-sm" style="background-color: rgba(255, 255, 255, 0.9);">
            <div class="card-body">
                <div class="card" style="color: rgb(163, 75, 102); box-shadow: 5px 6px 12px rgb(219, 217, 251); background-color: rgba(255, 255, 255, 0.9); padding: 20px;">
                    <h2 class="text-center" style="font-family: 'Quintessential', cursive;"><b>Tambah Data Porto</b></h2>
                </div>
                  ...
                  <ol class="breadcrumb mb-4" style="background-color:  rgba(255, 255, 255, 0.9)">
                      ...
                      <li class="breadcrumb-item active" style="color:rgb(201, 167, 167)">Tambah Data Porto</li>
                  </ol>
   
                <form action="/insertporto" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
